...
javac -d "build\classes" framework\annotation\Controller.java framework\annotation\GetMapping.java framework\annotation\Param.java framework\annotation\PostMapping.java framework\annotation\SimpleMapping.java framework\annotation\ModelAttribute.java framework\annotation\RestController.java framework\annotation\Session.java
